...
function simple(a, b: Pointer): Boolean;
begin
...
begin
  ...
  Int64(4), Int64(5), 6, Double(7.7), Int64(8), Int64(9), Int64(10)], @dbl, ccReg, TypeInfo(Double), True, False);
  Writeln(dbl);
  HppMagic.Invoke1(@asm_addi64andflt_10, [Int64(1), Int64(2), Int64(3),
  Int64(4), Int64(5), 6, Double(7.7), Int64(8), Int64(9), Int64(10)], @s, ccReg, TypeInfo(string), True, False);
  Writeln(s);
  HppMagic.Invoke1(@asm_add64_10, [Int64(1), Int64(2), Int64(3), string('asm_add64_10 prefix'),
  Int64(4), Int64(5), 6, Integer(7), Double(8.18), Int64(9), Int64(10)], @s, ccReg, TypeInfo(string), True, False);
  Writeln(s);
